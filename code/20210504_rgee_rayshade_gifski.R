...
aoi <- mapedit::editMap()
project_name <- "fort_mac" #unique name for the project
...
L7SR1v1 <- ee$ImageCollection('LANDSAT/LE07/C01/T1_SR')$filterDate('1999-01-01', '2003-01-01')
L7SR1v2 <- ee$ImageCollection('LANDSAT/LE07/C01/T1_SR')$filterDate('2012-01-01', '2013-01-01')

...
*Pro tip #1: Keep the polygon simple, ideally just a rectangle.* 
*Pro tip #2: The larger the polygon, the slower the workflow, start small!*
...
```{r proj}
resolution <- 60 # Imagery and DEM resolution in m
...
## Landsat pre-processing functions (optional)
...
## Download 8-bit RGB annual mosaics
...
# Wait 10ish minutes for downloads to complete...
...
# Interpolate missing data (optional)
...
In the figure above, we see black spots. These are no data pixels.

## Impute missing data in the timeseries 

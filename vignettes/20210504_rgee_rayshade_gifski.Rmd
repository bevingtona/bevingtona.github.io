...
```{r initialize}
rgee::ee_Initialize(user = "bevingtona", drive = T)
```
...
project_name <- "castle" #unique name for the project
...
yearEnd <- 2021 # filter year included in mosaics.
...
slow_impute <- function(band_no=1){
...
lapply(years, function(year=2021){
...
render_scalebar(limits=c(0, 5, 10),
                label_unit = "km",position = "E", 
                y=50,
                scale_length = c(0.33,1))
render_compass(position = "N", compass_radius = 20)

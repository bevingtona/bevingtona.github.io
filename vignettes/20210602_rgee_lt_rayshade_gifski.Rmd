...
project_name <- "random_mine" #unique name for the project
...
endDay = '09-20'
index = 'NBR'
maskThese = c('cloud', 'shadow')

runParams = c(
  maxSegments=           6,
  spikeThreshold=        0.9,
  vertexCountOvershoot=  3,
  preventOneYearRecovery=T,
...
changeParams = c(
  delta=  'loss',
  sort=   'greatest',
  year=   c(checked=T, start=1986, end=2017),
  mag=    c(checked=T, value=200,  operator='>'),
  dur=    c(checked=T, value=4,    operator='<'),
  preval= c(checked=T, value=300,  operator='>'),
  mmu=    c(checked=T, value=11))
